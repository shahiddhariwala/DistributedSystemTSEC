...
/**
* MuxixApp/doubleqty1Helper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from Muxix.idl
* Sunday, 4 February, 2018 9:15:05 PM IST
*/

abstract public class doubleqty1Helper
{
  private static String  _id = "IDL:MuxixApp/doubleqty1:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (MuxixApp.doubleqty1Helper.id (), "doubleqty1", __typeCode);
    }
    return __typeCode;
  }
