...
/**
* MuxixApp/doubleremHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from Muxix.idl
* Sunday, 4 February, 2018 9:15:04 PM IST
*/

abstract public class doubleremHelper
{
  private static String  _id = "IDL:MuxixApp/doublerem:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (MuxixApp.doubleremHelper.id (), "doublerem", __typeCode);
    }
    return __typeCode;
  }
